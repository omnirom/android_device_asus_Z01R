...
public class Startup extends BroadcastReceiver {
    ...
    private static void restore(String key, boolean enabled) {
        ...
        GestureSettings.setGestureEnabled(GestureSettings.getGestureFile(key), enabled);
    }
    ...
    public static void restoreAfterUserSwitch(Context context) {
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.KEY_L_APP, enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.KEY_M_APP, enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.KEY_O_APP, enabled);
        ...
        value = Settings.System.getString(context.getContentResolver(), mapping);
        enabled = !TextUtils.isEmpty(value) && !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.KEY_UP_APP, enabled);
        ...
        value = Settings.System.getString(context.getContentResolver(), mapping);
        enabled = !TextUtils.isEmpty(value) && !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.KEY_DOWN_APP, enabled);
