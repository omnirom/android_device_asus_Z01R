...
public class Startup extends BroadcastReceiver {
    ...
    public static void restoreAfterUserSwitch(Context context) {
        ...
        restore(GestureSettings.getGestureFile(KEY_C_APP), enabled);
        ...
        restore(GestureSettings.getGestureFile(KEY_E_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_L_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_M_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_O_APP), enabled);
        ...
        restore(GestureSettings.getGestureFile(KEY_S_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_V_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_W_APP), enabled);
        ...
        enabled = !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_Z_APP), enabled);
        ...
        value = Settings.System.getString(context.getContentResolver(), mapping);
        enabled = !TextUtils.isEmpty(value) && !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_UP_APP), enabled);
        ...
        value = Settings.System.getString(context.getContentResolver(), mapping);
        enabled = !TextUtils.isEmpty(value) && !value.equals(AppSelectListPreference.DISABLED_ENTRY);
        restore(GestureSettings.getGestureFile(KEY_DOWN_APP), enabled);
